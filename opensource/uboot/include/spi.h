 ...
 */
int  spi_xfer(unsigned char sfc_index,struct spi_slave *slave, unsigned int bitlen, const void *dout,
...
static inline int spi_w8r8(struct spi_slave *slave, unsigned char byte)
{
	...
	ret = spi_xfer(0,slave, 16, dout, din, SPI_XFER_BEGIN | SPI_XFER_END);
