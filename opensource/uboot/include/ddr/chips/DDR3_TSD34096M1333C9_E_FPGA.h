...
#define DDR_tRP  DDR__ns(48)	/* tRP: PRECHARGE command teriod to the same bank. ns*/
#define DDR_tRCD DDR__ns(48)	/* ACTIVE to READ or WRITE command period to the same bank. ns*/
#define DDR_tRC  DDR__ns(50)	/* ACTIVE to ACTIVE command period to the same bank. ns*/
#define DDR_tWR  DDR__ns(14)	/*The spec minimum is 15 ns,but need >= 5tck,so num is >= 90 ns*/    /* WRITE Recovery Time defined by register MR of DDR2 memory, ns*/
