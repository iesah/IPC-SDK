...
#define DDR_tRL 	DDR__tck(DDR_tAL + DDR_CL)	/* DDR3: Read Latency = tAL + tCL */
#define DDR_tWL 	DDR__tck(DDR_tAL + DDR_tCWL)	/* DDR3: Write Latency = tAL + tCWL */
#define DDR_tRDLAT	(DDR_tRL - DDR__tck(3))
#define DDR_tWDLAT	(DDR_tWL - DDR__tck(1))
#define DDR_tRTW 	(DDR_RL + DDR_tCCD - DDR_tWL + DDR__tck(2))	/* Read to Write delay */
