...
struct desc descriptors[11] = {
     ...
     *T41 PLL 600000000M : (((0x4a) << 20) | ((0x0) << 14) | ((0x1) << 11) | ((0x2) << 7) | ((0x3) << 4))
     * */
	{0xb0000010,		0xb0000010,	    0x04a00931, 0x8,	0},

    /* APLL=792MHZ
    *  PLLM  :0x41 ; PLLN  :0x0 ;PLLOD :0x1 ;PLLOD1:0x1 ;PLLRG :0x3
    *  T41 PLL 792000000M : (((0x41) << 20) | ((0x0) << 14) | ((0x1) << 11) | ((0x1) << 7) | ((0x3) << 4))
    */
     ...
     *T41 PLL 1200000000M : (((0x63) << 20) | ((0x0) << 14) | ((0x1) << 11) | ((0x1) << 7) | ((0x3) << 4))
     * */
	{0xb0000014,		0xb0000014,		0x063008b1, 0x8,	0},

    /*VPLL = 1000
     *T41 PLL 1000000000M : (((0x7c) << 20) | ((0x0) << 14) | ((0x1) << 11) | ((0x2) << 7) | ((0x3) << 4))
