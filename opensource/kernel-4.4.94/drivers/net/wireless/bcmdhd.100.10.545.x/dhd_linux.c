...
//	if (!dhd_download_fw_on_driverload) {
		...
		fw = VENDOR_PATH CONFIG_BCMDHD_100_10_545_X_FW_PATH;
#endif /* CONFIG_BCMDHD_100_10_545_X_FW_PATH */
#ifdef CONFIG_BCMDHD_100_10_545_X_NVRAM_PATH
		nv = VENDOR_PATH CONFIG_BCMDHD_100_10_545_X_NVRAM_PATH;
#endif /* CONFIG_BCMDHD_100_10_545_X_NVRAM_PATH */
//	}
...
extern bool dhd_update_btfw_path(dhd_info_t *dhdinfo, char* btfw_path)
{
	...
	/* set default firmware and nvram path for built-in type driver */
	if (!dhd_download_fw_on_driverload) {
#ifdef CONFIG_BCMDHD_100_10_545_X_BTFW_PATH
		fw = CONFIG_BCMDHD_100_10_545_X_BTFW_PATH;
#endif /* CONFIG_BCMDHD_100_10_545_X_FW_PATH */
	}
...
{
	struct file *fp;
	char *filepath = VENDOR_PATH CONFIG_BCMDHD_100_10_545_X_CLM_PATH;
