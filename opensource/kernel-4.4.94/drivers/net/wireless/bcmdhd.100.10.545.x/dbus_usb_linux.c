...
#ifdef OEM_ANDROID
#define CONFIG_ANDROID_BCMDHD_100_10_545_X_FW_PATH "broadcom/dhd/firmware/fw.bin.trx"
#define CONFIG_ANDROID_BCMDHD_100_10_545_X_NVRAM_PATH "broadcom/dhd/nvrams/nvm.txt"
#endif /* OEM_ANDROID */
...
#else
	snprintf(file_name, sizeof(file_name), "%s", CONFIG_ANDROID_BCMDHD_100_10_545_X_FW_PATH);
#endif /* OEM_ANDROID */
...
#else
	snprintf(file_name, sizeof(file_name), "%s", CONFIG_ANDROID_BCMDHD_100_10_545_X_NVRAM_PATH);
#endif /* OEM_ANDROID */
