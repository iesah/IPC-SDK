...
#else
	user_efuse_data_len = strlen(user_efuse_data);
	file_size = user_efuse_data_len;
	file_data = user_efuse_data;
	read_size = file_size;
#endif
...
exit:
	if (file_data && file_data != user_efuse_data)
