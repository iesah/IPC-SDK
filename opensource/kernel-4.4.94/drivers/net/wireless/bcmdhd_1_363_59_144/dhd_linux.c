...
dhd_open(struct net_device *net)
{
	...
	if (ifidx == 0) {
		...
		if (dhd->pub.conf->dpc_cpucore >= 0) {
			...
			adapter = dhd_wifi_platform_get_adapter(NULL, bus_type, bus_num, slot_num);
			if (adapter) {
...
//	if (!dhd_download_fw_on_driverload) {
#ifdef CONFIG_BCMDHD_1_363_59_144_FW_PATH
		fw = CONFIG_BCMDHD_1_363_59_144_FW_PATH;
#endif /* CONFIG_BCMDHD_1_363_59_144_FW_PATH */
#ifdef CONFIG_BCMDHD_1_363_59_144_NVRAM_PATH
		nv = CONFIG_BCMDHD_1_363_59_144_NVRAM_PATH;
#endif /* CONFIG_BCMDHD_1_363_59_144_NVRAM_PATH */
//	}
