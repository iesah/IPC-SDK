...
struct dsi_device * jzdsi_init(struct jzdsi_data *pdata)
{
	...
	pr_debug("entry %s()\n", __func__);
	 ...
	 //*(volatile unsigned int *)0xb00750a0 = 0xf;     //control-->phy reset
