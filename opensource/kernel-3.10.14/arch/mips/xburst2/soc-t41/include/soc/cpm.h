...
#define USBPCR_INCR_MASK                27
#define USBPCR_POR_BIT                  22
#define USBPCR_POR                      USBPCR_POR_BIT
...
#define OPCR_MASK_INT		BIT(30)
#define OPCR_SCLKACLK_GATE  BIT(28)
#define OPCR_REQ_MODE		BIT(24)
#define OPCR_USB_PHY_GATE   BIT(23)
#define OPCR_TCU_RTCCLK_GATE   		BIT(21)
#define OPCR_TCU_EXCLK_GATE   		BIT(20)
#define OPCR_O1ST   		BIT(8) /* BIT19:BIT8 */
#define OPCR_USB_SPENDN0    BIT(7)
#define OPCR_USB_SPENDN1    BIT(6)
#define OPCR_O1SE   		BIT(4)
#define OPCR_ERCS			(0x1<<2)
#define OPCR_BUS_MODE   	BIT(1)
