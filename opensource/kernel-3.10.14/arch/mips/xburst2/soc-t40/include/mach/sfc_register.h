...
#define SFC_CMD_IDX             (0x007c) //T40 ADD
#define SFC_COL_ADDR            (0x0080) //T40 ADD
#define SFC_ROW_ADDR            (0x0084) //T40 ADD
#define SFC_STA_ADDR0           (0x0088) //T40 ADD
#define SFC_STA_ADDR1           (0x008c) //T40 ADD
#define SFC_DES_ADDR            (0x0090) //T40 ADD
#define SFC_GLB1				(0x0094) //T40 ADD
#define SFC_DEV1_STA_RT			(0x0098) //T40 ADD
#define	SFC_TRAN_CONF1(n)		(0x009c + (n * 4)) //T40 ADD
#define SFC_CDT                 (0x0800)  //0x800 ~ 0xbff T40 ADD
#define	SFC_RM_DR				(0x1000)

/* For SFC_GLB0 T40 modify GLB->GLB0 */
#define GLB0_POLL_TIME_OFFSET		(16) //T40 ADD
#define GLB0_POLL_TIME_MSK			(0xffff << GLB0_POLL_TIME_OFFSET) //T40 ADD
#define GLB0_DES_EN					(1 << 15) //T40 ADD
#define GLB0_CDT_EN					(1 << 14) //T40 ADD
...
#define GLB0_OP_OFFSET              (6) //T40 ADD
...
/* For SFC_DEV_CONF */
#define DEV_CONF_STA_ENDIAN_OFFSET	(31) //T40 ADD
#define	STA_ENDIAN_LSB				(0) //T40 ADD
#define	STA_ENDIAN_MSB				(1) //T40 ADD
#define	DEV_CONF_SMP_DELAY_OFFSET	(16)
#define	DEV_CONF_SMP_DELAY_MSK		(0x1f << DEV_CONF_SMP_DELAY_OFFSET)
#define DEV_CONF_SMP_DELAY_0		(0) //T40 ADD
...
/* For SFC_TRAN_CONF0 T40 modify CONF->CONF0 */
#define	TRAN_CONF0_CLK_MODE				(29) //T40 modify TRAN->CLK
...
/* For SFC_SCR */
#define SFC_WORKING		(1 << 7) //T40 ADD
#define SFC_BUSY		(0x3 << 5) //T40 ADD
#define	CLR_END			(1 << 4)
#define CLR_TREQ		(1 << 3)
#define CLR_RREQ		(1 << 2)
#define CLR_OVER		(1 << 1)
