...
struct jz_gpio_func_def platform_devio_array[] = {
	...
	I2C0_PORTA,
#endif
#ifdef CONFIG_I2C0_PC16_PC17
	I2C0_PORTC,
#endif
#ifdef CONFIG_I2C1_PA17_PA18
	I2C1_PORTA,
#endif
#ifdef CONFIG_I2C1_PB17_PB18
	I2C1_PORTB,
#endif
#ifdef CONFIG_I2C1_PD26_PD27
	I2C1_PORTD,
#endif
#ifdef CONFIG_I2C2_PB25_PB26
	I2C2_PORTB,
#endif
#ifdef CONFIG_I2C2_PC14_PC15
	I2C2_PORTC,
#endif
#ifdef CONFIG_I2C3_PA21_PA22
	I2C3_PORTA,
#endif
#ifdef CONFIG_I2C3_PB28_PB29
	I2C3_PORTB,
#endif
	...
	SSISLV_PORTC,
#endif
#ifdef CONFIG_JZ_SPISLV_PD
	SSISLV_PORTD,
#endif
/* The board of T40 CYGNET uses spi1 and spislave to loop test */
	...
	GMAC_PORTB,
#endif
#ifdef CONFIG_T40_SLCD_TRULY_240_240
        DPU_PORTD_SLCD_8BIT,
#endif

#ifdef CONFIG_T40_TFT_BM8766
        DPU_PORTD_TFT_18BIT,
#endif

#ifdef CONFIG_T40_SLCD_KFM701A21
        DPU_PORTD_SLCD_16BIT,
#endif

#ifdef CONFIG_T40_SLCD_SPI_BYD9158B
        DPU_PORTD_SLCD_SPI,
#endif
