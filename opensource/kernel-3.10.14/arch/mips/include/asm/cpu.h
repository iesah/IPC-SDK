...
#define PRID_INGENIC_CORE_MASK 0x0000E000
#define   PRID_INGENIC_CORE_XBURST	(0 << 13)
#define   PRID_INGENIC_CORE_XBURST_II	(1 << 13)
...
/* Make compacted with 'old code' in 3.10.14 */
#define MIPS_CPU_CM2            MBIT_ULL(53)    /* CPU has CM2 */
#define MIPS_CPU_CM2_L2SYNC     MBIT_ULL(54)    /* CPU has CM2 L2-only SYNC feature */
